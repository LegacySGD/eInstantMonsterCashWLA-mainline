...
public class MonsterCashWLAWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(MonsterCashWLAWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/WitchesRichesWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/WitchesRichesWLAIW/InitOutcome.xml").getDocumentElement();
